function BouerComponents(sharedOptions) {
  ...
  return [
    ...
    {
      path: '/components/' + lang + '/cli/create-project.html',
      route: '/cli/create-project.html',
      title: 'Creating a Project • CLI',
      mounted: mountedEvent,
      loaded: loadedEvent,
    },
    {
      path: '/components/' + lang + '/cli/create-component.html',
      route: '/cli/create-component.html',
      title: 'Creating Components • CLI',
      mounted: mountedEvent,
      loaded: loadedEvent,
    },
    {
      path: '/components/' + lang + '/cli/development.html',
      route: '/cli/development.html',
      title: 'Development • CLI',
      mounted: mountedEvent,
      loaded: loadedEvent,
    },
    {
      path: '/components/' + lang + '/cli/deployment.html',
      route: '/cli/deployment.html',
